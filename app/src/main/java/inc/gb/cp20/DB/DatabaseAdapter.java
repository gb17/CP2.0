...
public class DatabaseAdapter {
    ...
    private static final String BOOK = "TBPARTY";
    private static final String PLANDATA = "PLANDATA";
    ...
    public Cursor getAllData(String TabelName, String groupBy) {
        return db.query(TabelName, null, null, null, groupBy, null, null);
